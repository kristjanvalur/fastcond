    ...
    if by_benchmark:
        ...
        for bench_name, bench_results in by_benchmark.items():
            ...
            for result in bench_results:
                ...
                throughput = result["results"]["overall"].get(
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate HTML performance page from JSON results"
    )
    ...
    parser.add_argument(
        "--no-charts", action="store_true", help="Skip chart references"
    )
